...
@NamedQueries({
    ...
    @NamedQuery(name = "LnPlanoconta.findByCtaFinanceiro", query = "SELECT l FROM LnPlanoconta l, LnCategoria c WHERE l.catInCodigo = c.catInCodigo and l.ctaChAtivo = :ctaChAtivo and c.tipInCodigo in (3,4,5)"),
    @NamedQuery(name = "LnPlanoconta.findByAtivo", query = "SELECT l FROM LnPlanoconta l, LnCategoria c WHERE l.catInCodigo = c.catInCodigo and l.ctaChAtivo = :ctaChAtivo and c.tipInCodigo = 1"),
