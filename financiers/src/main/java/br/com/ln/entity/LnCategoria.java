...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "LnCategoria.findAll", query = "SELECT l FROM LnCategoria l"),
    ...
    @NamedQuery(name = "LnCategoria.findByCatChAtivo", query = "SELECT l FROM LnCategoria l WHERE l.catChAtivo = :catChAtivo")})
